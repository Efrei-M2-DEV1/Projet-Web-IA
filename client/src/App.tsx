...
import { getHistory, saveToHistory, clearHistory } from './services/history';
...
function App() {
  ...
  useEffect(() => {
    ...
    if (existingHistory.length === 0) {
      const exampleResult: AnalysisResult = {
        ...
        extractedText: 'Eau, Sucre, Farine de blé, Huile de palme, Levure, Sel, Conservateur E202, Émulsifiant E471, Agent de traitement de la farine E300',
        ingredients: [
          {
            name: 'Eau',
            category: 'other',
          ...
          },
          {
            name: 'Sucre',
            category: 'other',
            explanation: 'Consommé avec modération, peut contribuer à l\'obésité et au diabète.',
            riskLevel: 'low'
          },
          {
            name: 'Farine de blé',
            category: 'allergen',
            explanation: 'Contient du gluten. Allergène majeur pour les personnes intolérantes.',
            riskLevel: 'high'
          },
          {
            name: 'Huile de palme',
            category: 'other',
            explanation: 'Riche en acides gras saturés. Impact environnemental controversé.',
            riskLevel: 'medium'
          },
          {
            name: 'Conservateur E202',
            category: 'preservative',
            explanation: 'Sorbate de potassium. Généralement considéré comme sûr, mais peut causer des irritations chez certaines personnes sensibles.',
            riskLevel: 'low'
          },
          {
            name: 'Émulsifiant E471',
            category: 'additive',
            explanation: 'Mono et diglycérides d\'acides gras. Additif alimentaire courant, généralement bien toléré.',
            riskLevel: 'low'
          },
          {
            name: 'Agent de traitement E300',
            category: 'additive',
            explanation: 'Acide ascorbique (vitamine C). Utilisé comme antioxydant, sans risque connu.',
            riskLevel: 'none'
          }
        ],
        score: 65,
        ...
        summary: {
          positives: [
            'Présence de vitamine C (E300)',
            'Pas d\'additifs controversés majeurs'
          ],
          warnings: [
            'Contient du gluten (allergène)',
            'Huile de palme présente',
            'Teneur en sucre à surveiller'
          ],
          recommendations: [
            'Éviter si intolérance au gluten',
            'Consommer avec modération',
            'Privilégier des alternatives avec moins d\'additifs'
          ]
        }
      };
  ...
  const handleImageSelect = async (file: File, preview: string) => {
    ...
    try {
      ...
      setError('Erreur lors de l\'analyse. Veuillez réessayer ou vérifier que le serveur est démarré.');
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-yellow-400 to-amber-400 pb-24 md:pb-0 safe-area-top safe-area-bottom">
      {/* Pas de header sur mobile - interface fullscreen */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-bold text-gray-800">Analyseur d'Ingrédients</h1>
            </div>
            <div className="flex items-center gap-3">
              <button
                onClick={() => setShowHelp(true)}
